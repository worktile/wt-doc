...
##### 1.2 安全性 & 通知、提醒
我们知道不同工作场景中会有不同的角色，如研发场景中有前端工程师、服务端工程师、UI设计师、产品经理、测试工程师等；内容营销中会有审稿人、发稿人、投稿人等不同角色；而不同角色在项目中对应的职责及权限不。由此，Worktile 分别设计了角色模式、权限模式和安全模式等不同模式，分别满足不同场景下不同角色对应不同权限以及每种角色对任务不同的可见性等需求。
而当任务发生变动时的通知及任务开始/截止前的提醒，
**1）角色管理**
